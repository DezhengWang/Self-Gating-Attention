...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='MultiPatchFormerWGA',
    ...
    parser.add_argument('--topk_ratio', type=float, default=0.1, help='topk ratio')
    parser.add_argument('--is_sparse', default=True, help='using sparse')
    ...
    parser.add_argument('--dropout_alpha', type=float, default=0.1, help='dropout')
    parser.add_argument('--dropout_data', type=float, default=0.1, help='dropout')
    ...
    if args.is_training:
        ...
        exp = Exp(args)  # set experiments
        print('>>>>>>>testing : {}<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<'.format(setting))
        exp.test(args.model, setting, test=1)
        torch.cuda.empty_cache()
